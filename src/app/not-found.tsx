    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-background to-muted/50 p-6">
            <div className="relative">
                ...
                <h1 className="bg-gradient-to-r from-primary to-pink-500 bg-clip-text text-[10rem] font-extrabold leading-none text-transparent drop-shadow-lg">
                    404
                </h1>
            </div>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                ...
                <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="gap-2 border-2 transition-all hover:bg-secondary/10 hover:scale-105 hover:shadow-lg dark:bg-background dark:hover:bg-secondary/20"
                >
